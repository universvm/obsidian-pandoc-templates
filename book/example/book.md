...
_However_, I’d recommend staying away from material specifically targeted to language learners (fake conversations, textbook readings, etc). Try to aim for young native material instead (children manga, etc).
